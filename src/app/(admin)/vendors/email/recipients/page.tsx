...
import { VendorsTable, type VendorRow } from "@/components/vendors/VendorsTable";
...
export default function ModifyRecipientsPage() {
  const { selectedById, remove } = useVendorSelection();

  const rows = useMemo<VendorRow[]>(() => VENDORS_DEMO, []);
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                {selectedRecipients.length ? (
                  ...
                  <div className="text-[11px] font-medium text-[#9aa39a]">
                    Nessun destinatario selezionato. Seleziona almeno un venditore
